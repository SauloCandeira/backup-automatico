...
from  tb_Produtos P 
inner join tb_ProdutoVendas PV on P.cdProduto = PV.cdProduto
inner join tb_Vendas V on PV.cdVenda = V.cdVenda
inner join tb_Clientes C on V.cdCliente = C.cdCliente
-- MODELO IIII
select C.nmCliente, sum(PV.qtProduto) qtTotalProdutos, P.nmProduto, sum(P.vlProduto * PV.qtProduto) 
from  tb_Produtos P inner join tb_ProdutoVendas PV on P.cdProduto = PV.cdProduto
inner join tb_Vendas V on PV.cdVenda = V.cdVenda
inner join tb_Clientes C on V.cdCliente = C.cdCliente
group by C.nmCliente, P.nmProduto
-- MODELO IIIII
select C.nmCliente, sum(PV.qtProduto) qtTotalProdutos, sum(P.vlProduto * PV.qtProduto) as qtValorTotalVenda
from  tb_Produtos P inner join tb_ProdutoVendas PV on P.cdProduto = PV.cdProduto
inner join tb_Vendas V on PV.cdVenda = V.cdVenda
inner join tb_Clientes C on V.cdCliente = C.cdCliente
